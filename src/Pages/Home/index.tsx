...
function Home() {
  ...
  return <div className="relative flex flex-col main-font-style">
    <div className="w-screen overflow-hidden min-h-screen bg-[url(/bg.png)] pb-10 text-blue-950 text-[20px] pt-10 min-[1080px]:px-32 max-[1080px]:px-10 max-[400px]:px-4">
      {/* Loading bar */}
      {/* Loading bar */}
      <div className="relative w-full h-8 mb-4 bg-blue-900 bg-opacity-80">
      ...
      <div className="flex min-[880px]:flex-row max-[880px]:flex-col justify-between w-full min-[400px]:px-10 max-[400px]:px-2 mt-6">
        ...
        <div className="flex flex-col min-[880px]:w-1/3 max-[880px]:w-full gap-3 mx-auto text-center mb-10">
          ...
          <div
            className="w-full mx-auto text-center bg-pink-500 border cursor-pointer hover:shadow-blue-400 border-blue-950"
    ...
    {/* TODO: modalVisible */}
    {modalVisible ?
      <div className="fixed w-screen h-screen text-center bg-white bg-opacity-50">
        <div className="flex flex-col w-2/3 p-2 mx-auto my-[50px] bg-[#00023B] border-2 border-[#1775E7] overflow-auto">
          <div className="flex flex-col p-6 mx-auto  bg-[#00023B] border-4 border-[#1775E7] overflow-auto">
            <p className="text-[36px] font-bold text-white mb-4 text-center mt-2">
              Round Result - {result.totalPotPrice} BTC
            </p>
            <div className="flex flex-col w-full text-[#1775E7]">
            ...
            <div className="flex flex-col w-full mt-6 text-[#1775E7]">
              <p className="text-[22px] font-bold">
            ...
            <p className="text-[24px] text-white mt-4">
              Your Holiday Reward: {(result as any).resultObj[address] * 0.00000001} BTC
            </p>


            {
              (result as any).resultObj[address] == undefined ?
                <div className="p-2 w-[80px] text-xl text-white text-center bg-[#FA00FF] mt-10 mx-auto cursor-pointer" onClick={() => setModalVisible(false)}>
                  OK
                </div>
                :
                <div className="px-10 py-2 mx-auto mt-10 text-xl font-bold text-center text-[#00023B] bg-[#FA00FF] cursor-pointer" onClick={() => getRewardHandler()}>
                  CLAIM REWARD
                </div>
            }
